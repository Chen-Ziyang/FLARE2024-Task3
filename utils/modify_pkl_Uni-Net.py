...
## Before prediction, modify modalities
# root = '/data1/userdisk0/zychen/RESULTS_FOLDER/nnUNet/3d_fullres/' \
       # 'Task666_FLARE2024Challenge/nnUNetTrainerV2_FLARE_Big__nnUNetPlansFLARE24Big/plans.pkl'
# with open(root, 'rb') as file:
    # data = pickle.load(file)
# data['modalities'] = {0: 'MR'}
# data['normalization_schemes'] = OrderedDict([(0, 'MR')])
# with open(root, 'wb') as file:
    # pickle.dump(data, file)

# root = '/data1/userdisk0/zychen/RESULTS_FOLDER/nnUNet/3d_fullres/' \
       # 'Task666_FLARE2024Challenge/nnUNetTrainerV2_FLARE_Big__nnUNetPlansFLARE24Big/nnUNetPlansFLARE24Big_plans_3D.pkl'
# with open(root, 'rb') as file:
    # data = pickle.load(file)
# data['modalities'] = {0: 'MR'}
# data['normalization_schemes'] = OrderedDict([(0, 'MR')])
...
root = '/data1/userdisk0/zychen/RESULTS_FOLDER/nnUNet/3d_fullres/' \
       'Task666_FLARE2024Challenge/nnUNetTrainerV2_FLARE_Big__nnUNetPlansFLARE24Big/all/model_final_checkpoint.model.pkl'
with open(root, 'rb') as file:
    data = pickle.load(file)
data['init'] = ('/data1/userdisk0/zychen/RESULTS_FOLDER/nnUNet/3d_fullres/Task666_FLARE2024Challenge/'
                'nnUNetTrainerV2_FLARE_Big__nnUNetPlansFLARE24Big/nnUNetPlansFLARE24Big_plans_3D.pkl',
...
data['name'] = 'nnUNetTrainerV2_FLARE_Big'
