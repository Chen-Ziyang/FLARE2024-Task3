...
# from nnunet.training.dataloading.multi_threaded_augmenter import MultiThreadedAugmenter
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    if use_nondetMultiThreadedAugmenter:
        ...
        batchgenerator_train = NonDetMultiThreadedAugmenter(dataloader_train, tr_transforms,
                                                            params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
    else:
        batchgenerator_train = MultiThreadedAugmenter(dataloader_train, tr_transforms,
                                                      params.get('num_threads'),
...
def get_moreDA_augmentation_target_wlabel(dataloader_train, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
                            seeds_train=None, seeds_val=None, order_seg=1, order_data=3, deep_supervision_scales=None,
                            soft_ds=False,
                            classes=None, pin_memory=True, regions=None,
...
def get_moreDA_augmentation_target(dataloader_train, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
    ...
    tr_transforms.append(SpatialTransform(
        ...
        order_seg=order_seg, random_crop=params.get("random_crop"), p_el_per_sample=params.get("p_eldef"),
        p_scale_per_sample=params.get("p_scale"), p_rot_per_sample=params.get("p_rot"),
        independent_scale_for_each_axis=params.get("independent_scale_factor_for_each_axis"), label_key=None
    ))
