...
base = '/data1/userdisk0/zychen/nnUNet_raw_data_base'
# preprocessing_output_dir = '/data1/userdisk0/zychen/nnUNet_raw_data_base'
preprocessing_output_dir = '/erwen_SSD/2T/zychen/FLARE2024-Code/nnUNet_preprocessed'
# preprocessing_output_dir = '/czy_SSD/1T/zychen/FLARE2024-Code/nnUNet_preprocessed'
network_training_output_dir_base = '/data1/userdisk0/zychen/RESULTS_FOLDER'
