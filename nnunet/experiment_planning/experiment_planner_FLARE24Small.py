...
class ExperimentPlanner3D_FLARE24Small(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE24Small, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE24Small"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE24Small_plans_3D.pkl")
        self.unet_base_num_features = 16

    def get_target_spacing(self):
        # simply return the desired spacing as np.array
        return np.array([4.0, 1.2, 1.2]) # make sure this is float!!!! Not int!
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        batch_size = 32     # Generic_UNet.DEFAULT_BATCH_SIZE_3D  # This is what wirks with 128**3
