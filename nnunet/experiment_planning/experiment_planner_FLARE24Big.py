...
class ExperimentPlanner3D_FLARE24Big(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE24Big, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE24Big"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE24Big_plans_3D.pkl")
        self.unet_base_num_features = 32
        print(self.dataset_properties['modalities'])
