...
Our solution is built upon [MIC-DKFZ/nnUNet](https://github.com/MIC-DKFZ/nnUNet).
...
The key idea of the UDA phase is inspired by our [previous work](https://github.com/Chen-Ziyang/TriLA/).
